...
<body>
  <div class="wrapper">
    ...
    <form method="POST" action="{{ route('register') }}">
      ...
      <div class="input-box">
        <input type="text" id="name" placeholder="الاسم" maxlength="100" name="name" required>
        <x-input-error :messages="$errors->get('name')" class="input-error" />
      </div>

      <div class="input-box">
        <input type="text" id="user_name" placeholder="اسم المستخدم" maxlength="100"  name="user_name" required>
        <x-input-error :messages="$errors->get('user_name')" class="input-error" />
      </div>
      ...
      <div class="input-box">
        <input type="number" placeholder="المرتب" maxlength="11"  name="salary" required>
        <x-input-error :messages="$errors->get('salary')" class="input-error" />
      </div>

      <div class="input-box">
        <input type="tel" id="telephone" maxlength="13" placeholder="رقم الموبايل" minlength="11"  name="telephone" required>
        <x-input-error :messages="$errors->get('telephone')" class="input-error" />
      </div>

      <div class="input-box">
        <input type="text" id="city" maxlength="255" placeholder="المدينة"  name="city" required>
        <x-input-error :messages="$errors->get('city')" class="input-error" />
      </div>

      <div class="input-box">
        <input type="password" id="password" maxlength="30" minlength="8" placeholder="كلمة المرور" name="password" required>
        <x-input-error :messages="$errors->get('password')" class="input-error" />
      </div>

      <div class="input-box">
        <input type="password" id="confirm-password" minlength="8" maxlength="30" placeholder="تأكيد كلمة المرور" name="password_confirmation" required>
